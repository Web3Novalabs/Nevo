          ...
          steps={[
            {
              title: 'Pool created',
              description:
                'Donation pool is live and ready to accept contributions.',
              status: 'complete',
            },
            {
              title: 'First milestone',
              description:
                'Reach the initial funding goal to unlock the next phase.',
              status: 'complete',
            },
            {
              title: 'Final push',
              description:
                'Collect remaining funds and prepare for distribution.',
              status: 'current',
            },
            {
